...
from jafar.utils.project_utils import get_project_info
import subprocess
from pathlib import Path
import re
import time
from jafar.state.active_project import set_active_project, get_active_project


console = Console()
CONFIG_PATH = Path(__file__).parent / "../utils/projects_config.json"
